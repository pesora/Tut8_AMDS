...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PA3     ------> TIM5_CH4
    */
    GPIO_InitStruct.Pin = TIM5_CH4_BUZ_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(TIM5_CH4_BUZ_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    HAL_GPIO_DeInit(TIM2_CH1_IC1_GPIO_Port, TIM2_CH1_IC1_Pin);

    HAL_GPIO_DeInit(GPIOB, TIM2_CH3_IC2_Pin|TIM2_CH4_IC3_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOD, TIM4_CH1_IC4_Pin|TIM4_CH2_IC5_Pin|TIM4_CH3_IC6_Pin);
