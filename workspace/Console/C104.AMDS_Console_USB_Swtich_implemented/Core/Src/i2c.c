...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(TEMP_I2C1_SCL_GPIO_Port, TEMP_I2C1_SCL_Pin);

    HAL_GPIO_DeInit(TEMP_I2C1_SDA_GPIO_Port, TEMP_I2C1_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(BAT_I2C3_SDA_GPIO_Port, BAT_I2C3_SDA_Pin);

    HAL_GPIO_DeInit(BAT_I2C3_SCL_GPIO_Port, BAT_I2C3_SCL_Pin);
