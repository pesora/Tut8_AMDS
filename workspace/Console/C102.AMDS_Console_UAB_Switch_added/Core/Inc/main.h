...
#define SEL_DP1_Pin GPIO_PIN_0
#define SEL_DP1_GPIO_Port GPIOG
#define SEL_DP2_Pin GPIO_PIN_1
#define SEL_DP2_GPIO_Port GPIOG
...
#define USB_SEL_SW1_Pin GPIO_PIN_2
#define USB_SEL_SW1_GPIO_Port GPIOG
#define USB_SEL_SW2_Pin GPIO_PIN_3
#define USB_SEL_SW2_GPIO_Port GPIOG
